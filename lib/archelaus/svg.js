...
function animateViewBox(x, y, w, h) {
  ...
  var as = { attributeName: 'viewBox', values: vs, dur: '10s', fill: 'freeze' };
  Object.keys(as).forEach(function(k) { e.setAttributeNS(null, k, as[k]); });
  svg.appendChild(e);

  //e.beginElement(); // not necessary with the right NameSpace
